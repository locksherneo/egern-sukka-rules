...
- `non_ip/direct.conf:197: PROCESS-NAME,v2ray`
- `non_ip/direct.conf:198: PROCESS-NAME,xray`
- `non_ip/direct.conf:199: PROCESS-NAME,ss-local`
- `non_ip/direct.conf:200: PROCESS-NAME,clash`
- `non_ip/direct.conf:201: PROCESS-NAME,ClashX`
- `non_ip/direct.conf:202: PROCESS-NAME,trojan`
- `non_ip/direct.conf:203: PROCESS-NAME,trojan-go`
- `non_ip/direct.conf:204: PROCESS-NAME,privoxy`
- `non_ip/direct.conf:205: PROCESS-NAME,cloudflared`
- `non_ip/direct.conf:206: PROCESS-NAME,aria2c`
- `non_ip/direct.conf:207: PROCESS-NAME,fdm`
- `non_ip/direct.conf:208: PROCESS-NAME,Folx`
- `non_ip/direct.conf:209: PROCESS-NAME,NetTransport`
- `non_ip/direct.conf:210: PROCESS-NAME,Thunder`
- `non_ip/direct.conf:211: PROCESS-NAME,ThunderVIP`
- `non_ip/direct.conf:212: PROCESS-NAME,Transmission`
- `non_ip/direct.conf:213: PROCESS-NAME,transmission-daemon`
- `non_ip/direct.conf:214: PROCESS-NAME,transmission-qt`
- `non_ip/direct.conf:215: PROCESS-NAME,BitComet`
- `non_ip/direct.conf:216: PROCESS-NAME,uTorrent`
- `non_ip/direct.conf:217: PROCESS-NAME,qbittorrent*`
- `non_ip/direct.conf:218: PROCESS-NAME,DownloadService`
- `non_ip/direct.conf:219: PROCESS-NAME,qBittorrent`
- `non_ip/direct.conf:220: PROCESS-NAME,qbittorrent-nox`
- `non_ip/direct.conf:221: PROCESS-NAME,WebTorrent`
- `non_ip/direct.conf:222: PROCESS-NAME,WebTorrent Helper`
- `non_ip/direct.conf:223: PROCESS-NAME,amuled`
- `non_ip/direct.conf:224: PROCESS-NAME,LocalSend`
- `non_ip/direct.conf:225: PROCESS-NAME,UUBooster`
- `non_ip/direct.conf:226: PROCESS-NAME,tailscaled`
- `non_ip/direct.conf:227: PROCESS-NAME,parsecd`
- `non_ip/direct.conf:228: PROCESS-NAME,SunloginClient_Desktop`
- `non_ip/direct.conf:229: PROCESS-NAME,SunloginClient_Helper`
- `non_ip/direct.conf:230: PROCESS-NAME,BaiduNetdisk_mac`
- `non_ip/direct.conf:231: PROCESS-NAME,Logi Options`
- `non_ip/direct.conf:232: PROCESS-NAME,Logi Options Daemon`
- `non_ip/my_direct.conf:13: PROCESS-NAME,nmap`
- `non_ip/my_reject.conf:59: PROCESS-NAME,Tencent Lemon`
- `non_ip/my_reject.conf:60: PROCESS-NAME,LemonMonitor`
- `non_ip/my_reject.conf:61: PROCESS-NAME,LemonDaemon`
- `non_ip/my_reject.conf:62: PROCESS-NAME,LemonAgent`
- `non_ip/my_reject.conf:63: PROCESS-NAME,LemonService`
- `non_ip/my_reject.conf:65: AND,((DOMAIN-KEYWORD,genuine), (DOMAIN-KEYWORD,autodesk))`
- `non_ip/reject-no-drop.conf:58: AND,((PROTOCOL,UDP), (DOMAIN-SUFFIX,googlevideo.com))`

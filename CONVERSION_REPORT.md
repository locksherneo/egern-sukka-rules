...
non_ip/cloudmounter.conf: AND,((DOMAIN-SUFFIX,sharepoint.com),(PROCESS-NAME,*CloudMounter))
non_ip/cloudmounter.conf: AND,((DOMAIN-SUFFIX,sharepoint.com),(SRC-IP,10.0.0.0/8))
non_ip/cloudmounter.conf: AND,((DOMAIN-SUFFIX,sharepoint.com),(SRC-IP,172.16.0.0/12))
non_ip/cloudmounter.conf: AND,((DOMAIN-SUFFIX,sharepoint.com),(SRC-IP,192.168.0.0/16))
non_ip/cloudmounter.conf: AND,((DOMAIN-SUFFIX,graph.microsoft.com),(PROCESS-NAME,*CloudMounter))
non_ip/cloudmounter.conf: AND,((DOMAIN-SUFFIX,graph.microsoft.com),(SRC-IP,10.0.0.0/8))
non_ip/cloudmounter.conf: AND,((DOMAIN-SUFFIX,graph.microsoft.com),(SRC-IP,172.16.0.0/12))
non_ip/cloudmounter.conf: AND,((DOMAIN-SUFFIX,graph.microsoft.com),(SRC-IP,192.168.0.0/16))
non_ip/cloudmounter.conf: AND,((DOMAIN,www.googleapis.com),(PROCESS-NAME,*CloudMounter))
non_ip/cloudmounter.conf: AND,((DOMAIN,www.googleapis.com),(SRC-IP,10.0.0.0/8))
non_ip/cloudmounter.conf: AND,((DOMAIN,www.googleapis.com),(SRC-IP,172.16.0.0/12))
non_ip/cloudmounter.conf: AND,((DOMAIN,www.googleapis.com),(SRC-IP,192.168.0.0/16))
non_ip/cloudmounter.conf: AND,((DOMAIN,api.onedrive.com),(PROCESS-NAME,*CloudMounter))
non_ip/cloudmounter.conf: AND,((DOMAIN,api.onedrive.com),(SRC-IP,10.0.0.0/8))
non_ip/cloudmounter.conf: AND,((DOMAIN,api.onedrive.com),(SRC-IP,172.16.0.0/12))
non_ip/cloudmounter.conf: AND,((DOMAIN,api.onedrive.com),(SRC-IP,192.168.0.0/16))
non_ip/cloudmounter.conf: AND,((DOMAIN-SUFFIX,storage.live.com),(PROCESS-NAME,*CloudMounter))
non_ip/cloudmounter.conf: AND,((DOMAIN-SUFFIX,storage.live.com),(SRC-IP,10.0.0.0/8))
non_ip/cloudmounter.conf: AND,((DOMAIN-SUFFIX,storage.live.com),(SRC-IP,172.16.0.0/12))
non_ip/cloudmounter.conf: AND,((DOMAIN-SUFFIX,storage.live.com),(SRC-IP,192.168.0.0/16))
non_ip/cloudmounter.conf: AND,((DOMAIN-SUFFIX,files.1drv.com),(PROCESS-NAME,*CloudMounter))
non_ip/cloudmounter.conf: AND,((DOMAIN-SUFFIX,files.1drv.com),(SRC-IP,10.0.0.0/8))
non_ip/cloudmounter.conf: AND,((DOMAIN-SUFFIX,files.1drv.com),(SRC-IP,172.16.0.0/12))
non_ip/cloudmounter.conf: AND,((DOMAIN-SUFFIX,files.1drv.com),(SRC-IP,192.168.0.0/16))
non_ip/cloudmounter.conf: AND,((DOMAIN-SUFFIX,my.microsoftpersonalcontent.com),(PROCESS-NAME,*CloudMounter))
non_ip/cloudmounter.conf: AND,((DOMAIN-SUFFIX,my.microsoftpersonalcontent.com),(SRC-IP,10.0.0.0/8))
non_ip/cloudmounter.conf: AND,((DOMAIN-SUFFIX,my.microsoftpersonalcontent.com),(SRC-IP,172.16.0.0/12))
non_ip/cloudmounter.conf: AND,((DOMAIN-SUFFIX,my.microsoftpersonalcontent.com),(SRC-IP,192.168.0.0/16))
non_ip/cloudmounter.conf: AND,((DOMAIN-WILDCARD,*-medi*.svc.ms),(PROCESS-NAME,*CloudMounter))
non_ip/cloudmounter.conf: AND,((DOMAIN-WILDCARD,*-medi*.svc.ms),(SRC-IP,10.0.0.0/8))
non_ip/cloudmounter.conf: AND,((DOMAIN-WILDCARD,*-medi*.svc.ms),(SRC-IP,172.16.0.0/12))
non_ip/cloudmounter.conf: AND,((DOMAIN-WILDCARD,*-medi*.svc.ms),(SRC-IP,192.168.0.0/16))
non_ip/cloudmounter.conf: AND,((DOMAIN-SUFFIX,upload.box.com),(PROCESS-NAME,*CloudMounter))
non_ip/cloudmounter.conf: AND,((DOMAIN-SUFFIX,upload.box.com),(SRC-IP,10.0.0.0/8))
non_ip/cloudmounter.conf: AND,((DOMAIN-SUFFIX,upload.box.com),(SRC-IP,172.16.0.0/12))
non_ip/cloudmounter.conf: AND,((DOMAIN-SUFFIX,upload.box.com),(SRC-IP,192.168.0.0/16))
...
non_ip/my_reject.conf: AND,((DOMAIN-KEYWORD,genuine), (DOMAIN-KEYWORD,autodesk))
non_ip/reject-no-drop.conf: AND,((PROTOCOL,UDP), (DOMAIN-SUFFIX,googlevideo.com))
